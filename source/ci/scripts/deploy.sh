...
sed -e "s#\${APP_NAME}#$app_name#" -e "s#\${APP_PORT}#$app_port#" | kubectl --kubeconfig=kubeconfig apply -f -

sed -e "s#\${DEPLOY_IMAGE_NAME}#$deploy_image_name#" \
-e "s#\${APP_NAME}#$app_name#" service/cluster.yml \
-e "s#\${APP_PORT}#$app_port#" | kubectl --kubeconfig=kubeconfig apply -f -
